...
# load dataset
df = read_csv('df_hdb_mean_time.csv', header=0, index_col=0, squeeze=True)
...
out = pd.DataFrame({'monthtx': [24214,24215]*len(Towns),
					'town': [town for town in Towns for i in range(2)]})
